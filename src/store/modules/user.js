...
export const share = createAction(SHARE, AuthAPI.share);

// initial state
const initialState = Map({
    loggedInfo: Map({   // 현재 로그인 유저의 정보
        email: null,
        regDt: null,
        aliveCnt: null,
        likeCnt: null,
    ...
    validateed: false   // 현재 로그인중인지 아닌지 한번 서버측에 검증했음을 의미
});
